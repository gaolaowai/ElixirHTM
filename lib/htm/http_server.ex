defmodule HTM.HttpServer do
  ...
  def start(port) when is_integer(port) and port > 1023 do
    ...
    {:ok, listen_socket} =
      :gen_tcp.listen(port, [:binary, backlog: 1000, packet: :raw, active: false, reuseaddr: true])
  ...
  def accept_loop(listen_socket) do
    ...
    # pass control of this client socket to the pid,
    # so that if it dies, the socket dies with it.
